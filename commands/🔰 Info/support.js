...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      let button_public_invite = new MessageButton().setStyle('LINK').setLabel('Invite DJ Tamil').setURL("https://discord.com/api/oauth2/authorize?client_id=928614716564197406&permissions=8&scope=bot%20applications.commands")
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.gg/cqRRrAqUHK")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter('Clan Bot | powered by tamilanmessi.tech', 'https://imgur.com/jPItIw0.gif')
