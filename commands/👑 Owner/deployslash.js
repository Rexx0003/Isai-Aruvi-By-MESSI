    ...
    if (message.author.id != "502721763680190464")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only MESSI is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/tamilanmessi), open a Ticket and ask for it!`)
        ]
      });
    try {
